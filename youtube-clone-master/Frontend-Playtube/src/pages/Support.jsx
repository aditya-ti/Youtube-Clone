            ...
            <ul className="text-center flex flex-col items-center space-y-2">
              <li className="flex items-center">
                ...
                <div className="h-full">
                  <h2 className="text-lg font-bold my-0">Portfolio</h2>
                  <a
                    href="https://portfolio--rupakghosh.netlify.app/"
                    target="_blank"
              ...
              <li className="flex items-center">
                ...
                <div className="h-full">
                  ...
                  <a
                    href="https://www.linkedin.com/in/rupak-ghosh-949258244"
                    target="_blank"
                    className="text-blue-500 text-sm hover:text-blue-400 "
                  >
                    /Rupak_Linkdien
              ...
              <li className="flex items-center">
                ...
                <div className="h-full">
                  ...
                  <p className="text-blue-500 text-sm hover:text-blue-400 ">@rupak6163</p>
                </div>
              </li>
            </ul>
          </div>
